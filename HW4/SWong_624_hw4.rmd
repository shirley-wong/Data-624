...
- Create dummy variables for the categorical predictor "Type". If we are using tree models, create 6 dummy variables for all 6 levels (1,2,3,5,6,7). If we are using general linear classification models, e.g. logistics, create 5 dummy variables for any 5 out of the 6 levels.
